    ...
    <div class="container-fluid text-center">
        <div class="row">
            ...
            <div class="col-md-7" id="invoice">
                ...
                <!-- Invoice Header -->
                <div class="row" id="invoiceHead" >
                    <div class="col-md-2" >
                        <img id="logo" src="images/CA.png" alt="...">
                    </div>
                    <div class="col-md-8" id="title">
                        <h1 id="firmName"><b>Jinal Waghela & Associates</b></h1>
                        <h3 id="firmProprieiter"><b>Proprietor : Jinal Mistry</b></h3>
                        
                        <!-- Date and Invoice Table -->
                        <div class="row" id="dateNtitle">
                ...
                <div class="mt-3">
                    ...
                    <b><p class="text-left">Amount in Words: &nbsp;&nbsp; Rupees Two Thousand Only</p></b>
                </div>
